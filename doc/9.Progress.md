...
- attribute relation can use content relations, or attribute stored relations(eg. slides:[{id:<location_id1>, name: xxxx},{id:<location_id2>, name:xxxx}]) - not decided yet.
