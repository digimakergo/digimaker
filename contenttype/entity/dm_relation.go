...
func (q relationQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Relation, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for dm_relation")
	}
...
func (q relationQuery) All(ctx context.Context, exec boil.ContextExecutor) (RelationSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to Relation slice")
	}
...
func (q relationQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count dm_relation rows")
	}
...
func (q relationQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if dm_relation exists")
	}
...
func (o *Relation) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no dm_relation provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("entity: unable to upsert dm_relation, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert for dm_relation")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to retrieve unique values for dm_relation")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to populate default values for dm_relation")
	}
